...
<body>
	<div class="container">
		<div style="text-align: center;" class="mb-4"">
			<img src="images/logo.png" alt="MoneyMoni 로고"
				style="height: 78px; margin-top: 30px;">
		</div>
			...
			<div class="col product-card" data-bank="<%=p.getKorCoNm()%>"
				...
				<div class="card h-100 p-3">
					<div class="card-body">
						...
						<p class="card-text">
							🧾 <strong>가입 방법:</strong>
							<%=p.getJoinWay()%><br> 🕓 <strong>공시월:</strong>
							<%=p.getDclsMonth()%><br> 💡 <strong>만기 후 이자:</strong>
							<%=p.getMtrtInt()%><br> 🎯 <strong>우대 조건:</strong>
							<%=p.getSpclCnd()%><br> 🙅 <strong>가입 제한:</strong>
							<%=p.getJoinDeny()%><br> 👥 <strong>가입 대상:</strong>
							<%=p.getJoinMember()%>
						</p>
					</div>
				</div>
